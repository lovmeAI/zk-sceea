...
from PyQt5.QtWidgets import QWidget, QLabel, QHBoxLayout, QGridLayout, QSpacerItem, QSizePolicy, QGraphicsDropShadowEffect, QListWidget, QListWidgetItem
...
class NotificationWindow(QListWidget):
    '''主Class，调用info，success，warning，error'''
    _instance = None
